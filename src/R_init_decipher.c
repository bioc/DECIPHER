...
static const R_CallMethodDef callMethods[] = { // method call, pointer, num args
	...
	{"clusterML", (DL_FUNC) &clusterML, 10},
	...
	{"enumerateSequenceReducedAA", (DL_FUNC) &enumerateSequenceReducedAA, 8},
	...
	{"colScores", (DL_FUNC) &colScores, 9},
	{"colScoresAA", (DL_FUNC) &colScoresAA, 9},
	...
	{"radixOrder", (DL_FUNC) &radixOrder, 5},
	...
	{"cophenetic", (DL_FUNC) &cophenetic, 4},
	{"sumBins", (DL_FUNC) &sumBins, 2},
	{"dereplicate", (DL_FUNC) &dereplicate, 2},
	{"selectGroups", (DL_FUNC) &selectGroups, 5},
	{"firstHit", (DL_FUNC) &firstHit, 2},
	{"xorShift", (DL_FUNC) &xorShift, 2},
	{"sortedUnique", (DL_FUNC) &sortedUnique, 1},
	{"splitPartitions", (DL_FUNC) &splitPartitions, 5},
	{"searchIndex", (DL_FUNC) &searchIndex, 23},
